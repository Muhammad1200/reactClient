...
export default function MyAppBar() {
	...
	const loginLogoutControls = token ? <LoggedIn /> : <></>
	...
	const renderMobileMenu = (
	  ...
	  >
						...
						{
						token?
						<button className="btn btn-dark btn-sm small form-control" onClick={() => dispatch(logOut())} variant="contained" >Logout</button>
						: 
						<LoggedOut />
						}
						</MenuItem>
      ...
      <AppBar >
        <Toolbar>
          ...
          <div className={classes.sectionDesktop}>
						...
						{
						token?
						<button className="btn btn-dark btn-sm small" onClick={() => dispatch(logOut())} variant="contained" >Logout</button>
						: 
						<LoggedOut />
						}
          </div>
